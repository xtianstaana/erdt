...
class AllocationInline(TabularInline):
    ...
    def formfield_for_choice_field(self, db_field, request, **kwargs):
        if db_field.name == 'name':
            kwargs['choices'] = Grant_Allocation.FRDG_ALLOC_CHOICES
...
class FRDGAdmin(ERDTModelAdmin):
    form = MyForm
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        return super(FRDGAdmin, self).get_fieldsets(request, obj)
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        return super(FRDGAdmin, self).formfield_for_foreignkey(db_field, request, **kwargs)

    def get_form(self, request, obj=None):
        _thread_locals.request = request
        _thread_locals.obj = obj
        return super(FRDGAdmin, self).get_form(request, obj)
    ...
    def get_suit_form_tabs(self, request, obj=None):
        tabs = [('general', 'General'), ('allocation', 'Faculty Research Dissemination Grant Fund Allocations')]
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        return super(FRDGAdmin, self).get_readonly_fields(request, obj)
