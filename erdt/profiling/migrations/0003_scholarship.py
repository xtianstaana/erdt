    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('high_degree_univ', models.CharField(max_length=50, verbose_name=b"Highest degree's University")),
                ('thesis_topic', models.CharField(max_length=100, blank=True)),
                ('thesis_title', models.CharField(max_length=100, blank=True)),
                ('thesis_status', models.CharField(default=b'PR', max_length=2, choices=[(b'PR', b'Proposal'), (b'TF', b'Topic Finalized'), (b'PA', b'Proposal Approved'), (b'DF', b'Defended'), (b'QE', b'Qualifying Exam'), (b'CE', b'Candidacy Exam')])),
